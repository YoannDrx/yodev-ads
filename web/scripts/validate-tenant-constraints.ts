...
const constraints = [
  ...
  ['report_editions', 'report_editions_workspace_client_fk'],
  ['report_editions', 'report_editions_workspace_share_fk'],
  ['report_editions', 'report_editions_workspace_schedule_fk'],
