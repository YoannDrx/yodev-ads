...
const commands = [
  ...
  'verify-teams-oauth-actors', 'verify-report-management-actors', 'verify-public-report-actors', 'verify-domain-actors', 'verify-lifecycle-actors', 'verify-external-cleanup-admission', 'verify-domain-cleanup-reservations', 'verify-domain-cleanup-receipts', 'verify-report-editions', 'verify-scheduled-report-admission', 'verify-workspace-collections', 'verify-public-status', 'verify-portfolio', 'verify-portfolio-views', 'verify-activation-evidence', 'verify-membership-boundary', 'verify-membership-admission', 'verify-alert-quality', 'verify-operating-costs', 'verify-monitoring-actors', 'verify-task-actors', 'verify-settings-actors', 'verify-security-actors', 'verify-member-mutations', 'verify-task-recipients'].map((script) => ['tsx', `scripts/${script}.ts`]),
]
