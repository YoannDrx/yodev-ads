...
export function AnalyticalRecord({ item, currency, locale }: { item: AnalyticalPageItem; currency: string; locale: 'fr' | 'en' }) {
  ...
  return <article data-analytical-record className="min-w-0 rounded-xl border bg-white p-5">
