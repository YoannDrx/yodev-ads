...
La passkey virtuelle prouve le protocole de l’application avec Chromium, pas la compatibilité de tous les appareils physiques. La réception d’emails, la connexion Google réelle, les environnements déployés, le transfert d’agence et la recette de lancement demeurent des vérifications séparées. Aucune migration de schéma supplémentaire n’est nécessaire pour ce lot.
