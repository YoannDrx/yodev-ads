...
Avant le transport, le worker relit ses deux réservations, l’état du workspace, du compte, de la planification et du lien. Une rotation/révocation du token bloque la reprise de l’ancienne capacité. La finalisation est conditionnée au propriétaire de réservation et à la tentative du job ; un ancien worker ne peut pas effacer la réservation d’un successeur. Un effet externe déjà admis ne peut pas être annulé par une révocation ultérieure.
